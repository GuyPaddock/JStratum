...
public abstract class Message {
  /**
   * Constant for the name of the {@code id} field in the JSON object for this message.
   */
   ...
   *   understood.
   */
  public Message(final JSONObject jsonMessage)
  throws MalformedStratumMessageException {
    this.parseMessage(jsonMessage);
  }

  /**
   * Constructor for {@link Message} that initializes a new instance having the specified ID.
   *
   * @param id
   ...
   * serialization of any additional fields that they expect in the JSON message.</p>
   *
   ...
   * default behavior provides no validation logic, but sub-classes can override this method to
   * provide their own validation logic.</p>
   *
   * @param jsonMessage
   *   The message that was parsed.
   *
   * @throws MalformedStratumMessageException
   *   If the data parsed into this object from the provided message was incorrect for the type of
   *   message that was expected.
   */
  protected void validateParsedData(final JSONObject jsonMessage)
  throws MalformedStratumMessageException {
    // Default: do nothing.
  }
   ...
   *   message that was expected.
   */
  protected void parseId(final JSONObject jsonMessage)
  throws MalformedStratumMessageException {
    final Object id;
