 ...
 * messages they accept based on the state of their conversation with the other system.</p>
 *
...
extends AbstractMessageTransport {
   ...
   *
   * @return Either the current connection state; or {@code null} if this transport is not
   * connected.
   */
   ...
   * end, sets the current state of this transport's connection to the specified state, and starts
   * the new state.</p>
   *
